...
class ctrlDispositivos extends Controller
{
    ...
    {
        $max_date = DB::select("select max(m.tiempo) as tiempo medidas as m inner join dispositivos as d where m.id_dispositivo = d.id and d.identificador = ?", [$identificador])[0]->tiempo;
