...
class getdataReptilarioBad extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getdataReptilarioBad';
    ...
    public function handle()
    {
        ...
        foreach ($dispositivos as $dispositivo) {
            ...
            DB::insert("insert into medidas (tiempo, lectura, id_dispositivo, id_sensor) values (?, ?, ?, ?)", [$fecha, 99, $dispositivo->id, $sensores[0]->id_sensor_secundario]);
