...
class getdataAcuario extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($dispositivos as $dispositivo) {
            ...
            DB::insert('insert into medidas (tiempo, lectura, id_dispositivo, id_sensor) values (?, ?, ?, ?)', [$fecha, rand (25,27), $dispositivo->id, 20]);
            DB::insert('insert into medidas (tiempo, lectura, id_dispositivo, id_sensor) values (?, ?, ?, ?)', [$fecha, rand (20,24), $dispositivo->id, 24]);
            DB::insert('insert into medidas (tiempo, lectura, id_dispositivo, id_sensor) values (?, ?, ?, ?)', [$fecha, rand (6,7), $dispositivo->id, 25]);
